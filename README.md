...
Product: https://discreta.ca Website repo: https://github.com/ItsmePatrice/panic-necklace
...
Authentication, Firebase push notifications, Stripe subscriptions
...
Move Terraform state to a centralized S3 backend with state locking
Introduce an Application Load Balancer and Auto Scaling Group
Add centralized logging and monitoring (CloudWatch, Prometheus/Grafana)
Expand CI/CD with automated testing and deployment gates
Evaluate Amazon EKS if operational needs outgrow self-managed Kubernetes
Local Development
bash
